...
class Team extends React.Component {
  ...
  render() {
    ...
    const sectionHeader = {
      ...
      paragraph: 'Wir sind Ihre Moderatoren und begleiten Sie vor, während und nach Ihrer Online-Gedenkfeier: professionell, brachenerfahren und emotional kompetent.'
    };
